...
void FDeferredShadingSceneRenderer::CustomRender(
	FRDGBuilder& GraphBuilder,
...
void FDeferredShadingSceneRenderer::Render(FRHICommandListImmediate& RHICmdList)
{
	...
	CustomRender(GraphBuilder, SceneColorTexture.Target, SceneDepthTexture.Target, LightShaftOcclusionTexture, SceneTextures);
